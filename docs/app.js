const definitions = [
  ...
  ['ncrb_crime', 'NCRB crime indicators', 'Crime in India official tables', 'Edition-based', '#f778ba', ' records', 'https://ncrb.gov.in/crime-in-india.html', 'The National Crime Records Bureau publishes Crime in India tables covering reported offences, crime rates, and related public-safety measures.\n\nNCRB tables are edition-based and definitions change across reporting periods, so this card remains a source-status entry. data.gov.in\'s NCRB catalog pages were checked and did not return a stable machine-readable dataset at the time of writing; this is a live research target rather than a permanently closed one.'],
