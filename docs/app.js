const definitions = [
  ...
  ['fiscal_deficit', 'Fiscal deficit', 'Union fiscal deficit', 'Annual', '#f56c6c', 'INR bn', 'https://cga.nic.in/', 'The fiscal deficit is the gap between government expenditure and receipts excluding borrowings. It indicates how much the public sector needs to finance during a fiscal year.\n\nThe Economic Survey provides annual and cumulative fiscal tables, but not a clean monthly deficit series. This card remains pending until the Controller General of Accounts exposes a stable machine-readable monthly release.'],
